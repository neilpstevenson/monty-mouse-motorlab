...
//**** IO CONFIGURATION ****************************************************//
const uint8_t ENCODER_LEFT_CLK = 4;
const uint8_t ENCODER_LEFT_B = 5;
...
const uint8_t SWITCH_SELECT_PIN = 13;
const uint8_t SWITCH_GO_PIN = 12;
